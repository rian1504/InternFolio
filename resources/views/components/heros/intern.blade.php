...
<div
    class="relative bg-gradient-to-br from-slate-700 via-blue-800 to-slate-900 dark:from-gray-800 dark:via-gray-900 dark:to-gray-900 py-20 md:py-28 overflow-hidden">
