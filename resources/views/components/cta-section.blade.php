{{-- Wave Divider --}}
<div class="relative">
    <svg class="w-full h-12 md:h-16 text-gray-50" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path
...
<div class="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-indigo-700 py-20 md:py-24 overflow-hidden">
