    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <article
                    class="bg-white rounded-2xl shadow-lg p-8 md:p-10 border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <aside class="space-y-6">
                ...
                {{-- Author Card --}}
                <div
                    class="bg-gradient-to-br from-cyan-50 via-indigo-50 to-cyan-50 rounded-2xl shadow-lg p-6 border-2 border-cyan-200/50">
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-900">Penulis</h3>
                            <p class="text-xs text-gray-600">Kontributor tips ini</p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                    <div class="flex items-center justify-between mb-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-900">Tips Terkait</h3>
                        ...
                        @forelse ($suggestion['related_suggestions'] as $related)
                            <a href="{{ route('suggestion.show', $related['suggestion_uuid']) }}"
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <span
                                        class="text-sm font-semibold text-gray-900 group-hover:text-cyan-700 transition-colors flex-1 line-clamp-2">
